...
namespace mylib_const
{
	...
	const MyLib::Color DEFAULT_COLOR = MyLib::Color(1.0f, 1.0f, 1.0f, 1.0f);	// デフォルトの色
	const MyLib::Color FIELDCOLOR_01 = MyLib::Color(0.6f, 0.4f, 0.1f, 1.0f);	// フィールドの色
	const MyLib::Color PLAYERBEAM_COLOR = MyLib::Color(0.5f, 0.5f, 0.9f, 1.0f);	// プレイヤーのビーム色
	const MyLib::Color UNIONBEAM_COLOR = MyLib::Color(0.2f, 0.2f, 0.9f, 1.0f);	// プレイヤーのビーム色
	const MyLib::Color ENEMYBEAM_COLOR = MyLib::Color(0.8f, 0.1f, 0.8f, 1.0f);	// 敵のビーム色
	...
	const MyLib::Vector2 DEFAULT_VECTOR2 = MyLib::Vector2(0.0f, 0.0f);		// Vector2のデフォルト値
}
